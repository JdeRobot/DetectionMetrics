...
public:
    GenericLiveReader(const std::string& path, std::map<std::string, std::string>* deployer_params_map, const std::string& classNamesFile, const std::string& readerImplementation);
