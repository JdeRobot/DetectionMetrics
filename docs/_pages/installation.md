...
Voila!! You can now use DetectionSuite. Proceed to [beginner's tutorial](https://github.com/JdeRobot/DetectionSuite/wiki/Beginner's-Tutorial-to-DetectionSuite-Part-1) to get started.
